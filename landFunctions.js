...
document.querySelector("#main").onscroll = function () {
    ...
    if (posicion == 0) {
        ...
        menu.style.top = "0px";
        menu.style.borderBottom = "2px solid #ff6600";
        descuento.style.top = "47px";
        descuento.style.borderBottom = "2px solid #ff6600";
        linea.style.background = "#ff6600";
        guia.style.color = "#ff6600";
        guia.style.top = "294px";
        guia.style.left = "17px";
        perfil.style.borderBottom = "2px solid #ff6600";
        usuario.style.color = "#ff6600";
        entrar.style.color = "#ff6600";
        salir.style.color = "#ff6600";
        paginaActual.style.color = "#ff6600";
        ini.style.color = "#3a3a3a"
        que.style.color = "#3a3a3a"
        comprar.style.color = "#3a3a3a"
        nuestro.style.color = "#ff6600"
        ayuda.style.color = "#3a3a3a"
        pieIcono.style.color = "#3a3a3a"
